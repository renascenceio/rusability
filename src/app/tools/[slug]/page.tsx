...
export default async function ToolDetailPage(props: { params: Promise<{ slug: string}>}) {
 ...
 <header className="flex flex-col lg:flex-row items-start gap-12 pb-16">
 ...
 <h2 className="text-3xl font-bold tracking-tight text-[var(--foreground)]">Why marketing professionals love {tool.name}</h2>
 ...
 <h3 className="font-bold text-xs uppercase tracking-[0.2em] text-secondary mb-8 pb-4">Pricing Context</h3>
