    ...
    <div className="max-w-7xl mx-auto px-6 py-12 animate-in fade-in duration-700">
      <header className="mb-16 flex flex-col md:flex-row items-center gap-12">
         <div className="relative group">
            <div className="w-32 h-32 rounded-full bg-[var(--background)] border border-[var(--border)] flex items-center justify-center overflow-hidden">
            ...
            <div>
               ...
               <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  {activeTab === "saved" && contentMap.saved.map((article) => (
                    <div key={article.title} className="hig-card p-6 flex items-center justify-between group bg-[var(--background)] border-[var(--border)] shadow-none hover:border-[var(--border)]">
                       <div className="space-y-2">
                       ...
                       <div className="flex items-center gap-2">
                          ...
                          <button className="p-3 text-[var(--foreground)] hover:text-hig-blue bg-[var(--background)] border border-[var(--border)] rounded-xl transition-all">
                  ...
                  {activeTab === "drafts" && contentMap.drafts.map((article) => (
                    <Link href="/editor" key={article.title} className="hig-card p-6 flex items-center justify-between group bg-[var(--background)] border-[var(--border)] shadow-none hover:border-[var(--border)]">
                       <div className="space-y-2">
                  ...
                  {activeTab === "activity" && contentMap.activity.map((item, i) => (
                    <div key={i} className="flex items-center gap-6 p-4 border-l-2 border-[var(--border)] hover:border-hig-blue transition-colors">
            ...
            {isPro && (
              <div className="space-y-8 pt-8">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="hig-card p-8 space-y-4 bg-[var(--background)] relative overflow-hidden group border-[var(--border)] shadow-none border-b-2">
                       <div className="flex items-center gap-2 text-[var(--foreground)] group-hover:text-hig-blue transition-colors">
                    ...
                    <div className="hig-card p-8 space-y-4 bg-[var(--background)] border-[var(--border)] shadow-none border-b-2">
                       <div className="flex items-center gap-2 text-[var(--foreground)] group-hover:text-hig-blue transition-colors">
                    ...
                    <div className="hig-card p-8 space-y-4 bg-[var(--background)] border-[var(--border)] shadow-none border-b-2">
                       ...
                       <div className="flex items-center gap-1.5 text-[var(--foreground)] font-black text-[10px] uppercase">
                          Growing Network
                       </div>
                    </div>
                 </div>
         ...
         <aside className="space-y-12">
            <div className="hig-card p-8 bg-[var(--background)] border-[var(--border)] shadow-none border-b-2">
               <div className="flex items-center justify-between mb-8">
                  <h3 className="text-lg font-black uppercase tracking-widest text-[var(--foreground)]">Interests</h3>
               ...
               <div className="flex flex-wrap gap-2">
                  {INTERESTS.map((tag) => (
                    <span key={tag} className="bg-[var(--background)] px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest text-[var(--foreground)] border border-[var(--border)] hover:border-hig-blue hover:text-hig-blue transition-all cursor-pointer">
                      {tag}
                    </span>
                  ))}
               </div>
            ...
            <div className="p-8 hig-card bg-[var(--foreground)] text-[var(--background)] relative overflow-hidden group">
               <div className="relative z-10">
                   ...
                   <button className="w-full mt-10 text-[10px] font-black uppercase tracking-[0.2em] text-[var(--background)] hover:text-hig-blue transition-colors border-b border-[var(--background)]/10 pb-4 text-left flex items-center justify-between group">
